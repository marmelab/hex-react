...
export const gridPoints = (oX, oY, size, gridWidth, gridHeight) => product(gridHeight, gridWidth).map(([gridY, gridX]) => gridPoint(oX, oY, size, gridX, gridY));
